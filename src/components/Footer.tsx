  ...
  return (
    <footer className="bg-white/10 dark:bg-gray-800/50 backdrop-blur-sm">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-3 gap-8 text-white">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <Link
                href="https://www.instagram.com/47sinter?igsh=MWtwYmh4dXE4MGpvdQ=="
                className="text-white/80 hover:text-white transition"
              ...
              <Link
                href="https://youtube.com/@si47int?si=zoovAqC033KJckec"
                className="text-white/80 hover:text-white transition"
                aria-label="YouTube"
              >
                <svg
        ...
        <div className="border-t border-white/20 dark:border-gray-700 mt-8 pt-8 text-center text-white/60">
